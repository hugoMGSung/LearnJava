...
<form:form class="form-signin" name="form" id="form" role="form"
	...
	<div class="text-center mb-4">
		<h1 class="h3 mb-3 font-weight-normal">freeboard.hugo95.com</h1>
	</div>
	...
	<p class="mt-5 mb-3 text-muted text-center">© 2021. HUGO95. All
		rights reserved.</p>
</form:form>
<!-- login form {e} -->
<script>
	function fn_btnSignupClick() {
		location.href = "${pageContext.request.contextPath}/login/register";
	}
</script>
